    ...
    { 
      ...
      render: (_: any, record: StudentExamWithDetails) => (
        <div className="flex items-center space-x-2">
          ...
          <span className="text-gray-900">{record.exam?.title || 'N/A'}</span>
        </div>
      )
    },
    { 
      ...
      render: (_: any, record: StudentExamWithDetails) => (
        <div className="flex items-center space-x-2">
          ...
          <span className="text-gray-900">{record.exam?.course?.title || 'N/A'}</span>
        </div>
      )
    },
    { 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Students Taken Exam</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Students Not Taken</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Total Course Students</p>
      ...
      {selectedExam && studentsNotTakenExam.length > 0 && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <h4 className="text-md font-semibold text-yellow-800 mb-3 flex items-center">
            ...
            Students Who Haven't Taken This Exam ({studentsNotTakenExam.length})
          </h4>
      ...
      {!selectedExam && !loading && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            Choose an exam from the dropdown above to see student results and manage exam records.
          </p>
        </div>
      )}
